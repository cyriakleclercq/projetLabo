...
function ajaxRequest()
{
    ...
    xhttp.onreadystatechange = function() {
        ...
        $titre_quete1.innerHTML = quetes[13].nom;


        $desc_quetes1 = document.createElement ('p');
        $titre_quete1.appendChild ($desc_quetes1);
        $desc_quetes1.innerHTML = quetes[13].descriptif;
        ...
        $titre_quete2.innerHTML = quetes[14].nom;


        $desc_quetes2 = document.createElement ('p');
        $titre_quete2.appendChild ($desc_quetes2);
        $desc_quetes2.innerHTML = quetes[14].descriptif;
